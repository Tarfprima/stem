"""
Django settings for ste project.
...
ROOT_URLCONF = 'ste.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'], # чтобы static был виден в папке проекта а не в папке приложения. 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ste.wsgi.application'
